...
/*收藏夹商品详情（阿里百川商品详情页）*/
public class CollectShopDetailActivity extends BigBaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        AlibcTrade.show(CollectShopDetailActivity.this, webview, new MyWebViewClient(), new MyWebChromeClient(), page, alibcShowParams, null, exParams, new AlibcTradeCallback() {
    ...
    public void OnClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.re_share:
                ...
                break;
            case R.id.re_buy:/*购买*/
                if (NetUtil.getNetWorkState(CollectShopDetailActivity.this) < 0) {
    ...
    private void shareGaoYongJinData() {
        loadingDialog = DialogUtil.createLoadingDialog(CollectShopDetailActivity.this, "加载中...");
                    ...
                    public void onSuccess(int statusCode, JSONObject response) {
                        ...
                        try {
                            ...
                            if (jsonObject.getInt("status") >= 0) {
                                ...
                                DialogUtil.closeDialog(loadingDialog, CollectShopDetailActivity.this);
                    ...
                    public void onSuccess(int statusCode, JSONObject response) {
                        ...
                        try {
                            ...
                            if (jsonObject.getInt("status") >= 0) {
                                ...
                                exParams.put("isv_code", "appisvcode");
                                exParams.put("alibaba", "阿里巴巴");
                                AlibcTrade.show(CollectShopDetailActivity.this, page, alibcShowParams, null, exParams, new AlibcTradeCallback() {
                                    @Override
                                    public void onTradeSuccess(TradeResult tradeResult) {
                                        /*阿里百川进淘宝成功*/
                                    }
