...
public class GShenJiActivity extends BaseActivity {
    String url, getUrl;
    ...
    private void payData() {
        loadingDialog = DialogUtil.createLoadingDialog(GShenJiActivity.this, "加载中...");
                    ...
                    public void onSuccess(int statusCode, JSONObject response) {
                        ...
                        try {
                            ...
                            Runnable payRunnable = new Runnable() {
                                @Override
                                public void run() {
                                    PayTask alipay = new PayTask(GShenJiActivity.this);
