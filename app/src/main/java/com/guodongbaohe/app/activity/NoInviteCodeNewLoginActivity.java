...
public class NoInviteCodeNewLoginActivity extends BaseActivity {
    String phone;
    ...
    private void LoginData(String yanzma) {
        loadingDialog = DialogUtil.createLoadingDialog(NoInviteCodeNewLoginActivity.this, "正在登录");
    ...
    private void getCodeData() {
        long timelineStr = System.currentTimeMillis() / 1000;
        loadingDialog = DialogUtil.createLoadingDialog(NoInviteCodeNewLoginActivity.this, "正在获取验证码...");
        LinkedHashMap<String, String> map = new LinkedHashMap<>();
        map.put("phone", phone);
        map.put(Constant.TIMELINE, String.valueOf(timelineStr));
        map.put(Constant.PLATFORM, Constant.ANDROID);
