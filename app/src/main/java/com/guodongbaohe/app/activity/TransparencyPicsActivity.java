...
public class TransparencyPicsActivity extends BigBaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        one_bitmap_s = PreferUtils.getString(getApplicationContext(), "one_bitmap_s");
        all_list = new ArrayList<>();
        all_list.add(0, one_bitmap_s);
