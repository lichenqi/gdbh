...
import com.guodongbaohe.app.activity.SaveMoneyActivity;
...
public class NewRangingListFragment extends Fragment {
    ...
    @BindView(R.id.ll_savemoney)
    RelativeLayout ll_savemoney;
    boolean isLogin;
    ...
    @OnClick({R.id.ll_search, R.id.ll_savemoney})
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.ll_savemoney:
                if (PreferUtils.getBoolean(getContext(), "isLogin")) {
                    intent = new Intent(getContext(), SaveMoneyActivity.class);
                    startActivity(intent);
                } else {
