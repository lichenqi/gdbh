...
public class BarrageView extends FrameLayout {
    ...
    private long distanceTime = 2 * 1000L; //两条弹幕间隔时间
...
//        itemView.setY(getItemRamdomY());
        ...
        int itemViewH=itemView.getMeasuredHeight();
//        itemView.setX(this.barrageViewWidth);
        itemView.setY(this.barrageViewHeight);
        ...
        ImageView iv = (ImageView) itemView.findViewById(R.id.iv_headview);
        Glide
                .with(getContext())
        ...
        final ObjectAnimator anim = ObjectAnimator.ofFloat(itemView, "translationY", -itemViewH);
