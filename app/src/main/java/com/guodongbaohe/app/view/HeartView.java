        ...
        imageView.post(new Runnable() {
            ...
            public void run() {
                ...
                if (randomArray[new Random().nextInt(2)]==0) {
                    point1x=new Random().nextInt((width/4));
                }
                else {
                    point1x=new Random().nextInt((width/4))+(width/4+dp2px(context, 50));
                }
                if (randomArray[new Random().nextInt(2)]==0) {
                    point2x=new Random().nextInt((width/4));
                }
                else {
                    point2x=new Random().nextInt((width/4))+(width/4+dp2px(context, 50));
                }
                point1y=new Random().nextInt(height/4)+(height/4+dp2px(context, 50));
                point2y=-new Random().nextInt(point1y)+point1y;
                int endX=new Random().nextInt(dp2px(context, 100))+(width/4-dp2px(context, 100));
