...
public class MakeMoneyFragment extends Fragment {
    ...
    ImageView iv_income_tubiao;
    @BindView(R.id.tv_total_income)
    TextView tv_total_income;
    @BindView(R.id.tv_invite_code)
    TextView tv_invite_code;
    String son_count, member_role, userImg, userName, invite_code;
    Intent intent;
    /*合伙人显示*/
...
//                        intent = new Intent(getContext(), PartnerTopUpActivity.class);
    ...
    private void initImageView() {
        if (member_role.equals("2")) {
            ...
            iv_income_tubiao.setImageResource(R.mipmap.zongcaisru);
            tv_invite_code.setText("邀请ID: " + invite_code);
        } else if (member_role.equals("1")) {
            ll_user_and_vip.setVisibility(View.GONE);
            re_hehuoren_buju.setVisibility(View.VISIBLE);
            hehuoren_and_zcai_bg.setImageResource(R.mipmap.hehuorenbuju);
            iv_income_tubiao.setImageResource(R.mipmap.hehuorenzongshouru);
            tv_invite_code.setText("邀请ID: " + invite_code);
        } else {
    ...
    private void memberRoleFirst() {
        update_label.setText("升级至总裁享受最高特权");
        identity_label.setText("");
        tv_one.setText("购物省钱");
        tv_one_bili.setText("佣金90%");
        tv_two.setText("分享赚90%");
        tv_two_bili.setText("最高比例");
        tv_three.setText("总裁特训班");
        tv_three_bili.setText("定期开课");
        tv_four.setText("团队收益");
        tv_four_bili.setText("最高收益");
        tv_five.setText("多倍奖金");
        tv_five_bili.setText("最高奖励");
        tv_six.setText("总裁身份");
        tv_six_bili.setText("永久最高特权");
    ...
    private void haveSonData() {
        update_label.setText("升级至合伙人享受超多特权");
        identity_label.setText("您已达到升级合伙人的资格");
        tv_one.setText("购物省钱");
        tv_one_bili.setText("佣金82%");
        tv_two.setText("个人收入");
        tv_two_bili.setText("收入提升64%");
        tv_three.setText("果冻商学院");
        tv_three_bili.setText("每周内部培训");
        tv_four.setText("团队收益");
        tv_four_bili.setText("提升200%");
        tv_five.setText("获得奖金");
        tv_five_bili.setText("双倍收益");
        tv_six.setText("合伙人身份");
        tv_six_bili.setText("享受高级特权");
